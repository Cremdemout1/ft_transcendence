...
import {
  ...
  init_light,
  init_spotLight
} from "./chunk-56ETBK6J.js";
import {
  FlowGraphCoordinator,
  init_flowGraphCoordinator
} from "./chunk-4A335USX.js";
import {
  getAnimationTypeByFlowGraphType,
  init_flowGraphRichTypes
} from "./chunk-5DQZPT2M.js";
import {
  Bone,
  init_bone
} from "./chunk-6COYCBU3.js";
import {
  Animation,
  init_animation
} from "./chunk-MQ6RVYAF.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial,
...
} from "./chunk-YTRVVW6R.js";
import {
  Texture,
  init_texture
} from "./chunk-HYBBSRJ3.js";
import {
  Color3,
  Color4,
  init_math_color
} from "./chunk-HERXG5W6.js";
import {
  Matrix,
  Quaternion,
  TmpVectors,
...
import {
  ...
  init_buffer,
  init_bufferUtils
} from "./chunk-DSKV5K7A.js";
import {
  Tools,
  init_tools
} from "./chunk-KBIEY5F7.js";
import {
  ...
  init_error,
  init_fileTools
} from "./chunk-NGURQEAK.js";
import {
  RandomGUID,
  init_guid
} from "./chunk-UR34WXYY.js";
import {
  Effect,
  init_effect
} from "./chunk-PAN66ETS.js";
import {
  Observable,
  init_observable
} from "./chunk-ZY5JY2IR.js";
import {
  Logger,
  init_logger
} from "./chunk-QSGUJ46Y.js";
import {
  __esm,
  __export
...
var init_glTFLoaderExtensionRegistry = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/glTFLoaderExtensionRegistry.js"() {
    init_logger();
    RegisteredGLTFExtensions = /* @__PURE__ */ new Map();
  ...
  "node_modules/@babylonjs/loaders/glTF/2.0/glTFLoader.js"() {
    ...
    GLTFLoader2 = class _GLTFLoader {
      ...
      loadAnimationAsync(context, animation) {
        ...
        return import("./animationGroup-A3ZXQYYE.js").then(({ AnimationGroup }) => {
          this._babylonScene._blockEntityCollection = !!this._assetContainer;
      ...
      async _loadAnimationChannelAsync(context, animationContext, animation, channel, onLoad) {
        ...
        await import("./glTFLoaderAnimation-KIXTNMGC.js");
        let properties;
...
var NAME23, EXT_materials_diffuse_roughness;
var init_EXT_materials_diffuse_roughness = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/EXT_materials_diffuse_roughness.js"() {
    init_pbrMaterial();
    init_glTFLoader2();
    init_glTFLoaderExtensionRegistry();
    init_constants();
    NAME23 = "EXT_materials_diffuse_roughness";
    EXT_materials_diffuse_roughness = class {
      /**
       * @internal
       */
      constructor(loader) {
    ...
    registerGLTFExtension(NAME23, true, (loader) => new EXT_materials_diffuse_roughness(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_mesh_quantization.js
var NAME24, KHR_mesh_quantization;
var init_KHR_mesh_quantization = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_mesh_quantization.js"() {
    init_glTFLoaderExtensionRegistry();
    NAME24 = "KHR_mesh_quantization";
    ...
    registerGLTFExtension(NAME24, true, (loader) => new KHR_mesh_quantization(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_basisu.js
var NAME25, KHR_texture_basisu;
var init_KHR_texture_basisu = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_basisu.js"() {
    init_glTFLoader2();
    init_glTFLoaderExtensionRegistry();
    NAME25 = "KHR_texture_basisu";
    ...
    registerGLTFExtension(NAME25, true, (loader) => new KHR_texture_basisu(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_transform.js
var NAME26, KHR_texture_transform;
var init_KHR_texture_transform = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_transform.js"() {
    init_texture();
    init_glTFLoader2();
    init_glTFLoaderExtensionRegistry();
    NAME26 = "KHR_texture_transform";
    ...
    registerGLTFExtension(NAME26, true, (loader) => new KHR_texture_transform(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_xmp_json_ld.js
var NAME27, KHR_xmp_json_ld;
var init_KHR_xmp_json_ld = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_xmp_json_ld.js"() {
    init_glTFLoaderExtensionRegistry();
    NAME27 = "KHR_xmp_json_ld";
    KHR_xmp_json_ld = class {
      ...
      onLoading() {
        ...
        const xmpGltf = (_a = this._loader.gltf.extensions) == null ? void 0 : _a.KHR_xmp_json_ld;
        const xmpNode = (_c = (_b = this._loader.gltf.asset) == null ? void 0 : _b.extensions) == null ? void 0 : _c.KHR_xmp_json_ld;
        if (xmpGltf && xmpNode) {
    ...
    registerGLTFExtension(NAME27, true, (loader) => new KHR_xmp_json_ld(loader));
  }
});
...
var NAME28, KHR_animation_pointer;
var init_KHR_animation_pointer = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_animation_pointer.js"() {
    ...
    KHR_animation_pointer = class {
       ...
       */
      get enabled() {
        return this._loader.isExtensionUsed(NAME28);
      }
      /** @internal */
      dispose() {
        this._loader = null;
    ...
    registerGLTFExtension(NAME28, true, (loader) => new KHR_animation_pointer(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_audio_emitter.js
var NAME29, MSFT_audio_emitter;
var init_MSFT_audio_emitter = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_audio_emitter.js"() {
    ...
    registerGLTFExtension(NAME29, true, (loader) => new MSFT_audio_emitter(loader));
  }
});
  ...
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_lod.js"() {
    ...
    MSFT_lod = class {
      ...
      constructor(loader) {
        ...
        this._loader = loader;
        this.maxLODsToLoad = ((_a = this._loader.parent.extensionOptions[NAME30]) == null ? void 0 : _a.maxLODsToLoad) ?? this.maxLODsToLoad;
    ...
    registerGLTFExtension(NAME30, true, (loader) => new MSFT_lod(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_minecraftMesh.js
var NAME31, MSFT_minecraftMesh;
var init_MSFT_minecraftMesh = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_minecraftMesh.js"() {
    init_pbrMaterial();
    init_glTFLoader2();
    init_glTFLoaderExtensionRegistry();
    NAME31 = "MSFT_minecraftMesh";
    ...
    registerGLTFExtension(NAME31, true, (loader) => new MSFT_minecraftMesh(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_sRGBFactors.js
var NAME32, MSFT_sRGBFactors;
var init_MSFT_sRGBFactors = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_sRGBFactors.js"() {
    init_pbrMaterial();
    init_glTFLoader2();
    init_glTFLoaderExtensionRegistry();
    NAME32 = "MSFT_sRGBFactors";
    ...
    registerGLTFExtension(NAME32, true, (loader) => new MSFT_sRGBFactors(loader));
  }
});
...
var init_KHR_interactivity = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_interactivity.js"() {
    ...
    addToBlockFactory(NAME33, "FlowGraphGLTFDataProvider", async () => {
      return (await import("./flowGraphGLTFDataProvider-XHLMMUBC.js")).FlowGraphGLTFDataProvider;
    });
    unregisterGLTFExtension(NAME33);
    registerGLTFExtension(NAME33, true, (loader) => new KHR_interactivity(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_visibility.js
var NAME34, KHR_node_visibility;
var init_KHR_node_visibility = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_visibility.js"() {
    init_glTFLoaderExtensionRegistry();
    init_objectModelMapping();
    NAME34 = "KHR_node_visibility";
    ...
    registerGLTFExtension(NAME34, true, (loader) => new KHR_node_visibility(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_selectability.js
var NAME35, KHR_node_selectability;
var init_KHR_node_selectability = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_selectability.js"() {
    init_glTFLoaderExtensionRegistry();
    init_declarationMapper();
    init_objectModelMapping();
    NAME35 = "KHR_node_selectability";
    addNewInteractivityFlowGraphMapping("event/onSelect", NAME35, {
    ...
    registerGLTFExtension(NAME35, true, (loader) => new KHR_node_selectability(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_hoverability.js
var NAME36, MeshPointerOverPrefix, MeshPointerOutPrefix, KHR_node_hoverability;
var init_KHR_node_hoverability = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_hoverability.js"() {
    init_glTFLoaderExtensionRegistry();
    init_declarationMapper();
    init_objectModelMapping();
    NAME36 = "KHR_node_hoverability";
    MeshPointerOverPrefix = "targetMeshPointerOver_";
    addNewInteractivityFlowGraphMapping("event/onHoverIn", NAME36, {
      // using GetVariable as the nodeIndex is a configuration and not a value (i.e. it's not mutable)
    ...
    addNewInteractivityFlowGraphMapping("event/onHoverOut", NAME36, {
      // using GetVariable as the nodeIndex is a configuration and not a value (i.e. it's not mutable)
    ...
    registerGLTFExtension(NAME36, true, (loader) => new KHR_node_hoverability(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/ExtrasAsMetadata.js
var NAME37, ExtrasAsMetadata;
var init_ExtrasAsMetadata = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/ExtrasAsMetadata.js"() {
    init_glTFLoaderExtensionRegistry();
    NAME37 = "ExtrasAsMetadata";
    ...
    registerGLTFExtension(NAME37, false, (loader) => new ExtrasAsMetadata(loader));
  }
});

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_interactivity/index.js
...
var init_Extensions = __esm({
  "node_modules/@babylonjs/loaders/glTF/2.0/Extensions/index.js"() {
    ...
    init_EXT_materials_diffuse_roughness();
...
//# sourceMappingURL=chunk-BLOSGEVJ.js.map
