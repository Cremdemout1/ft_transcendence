...
var name, shader, minmaxReduxPixelShaderWGSL;
var init_minmaxRedux_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/minmaxRedux.fragment.js"() {
    init_shaderStore();
    name = "minmaxReduxPixelShader";
    shader = `varying vUV: vec2f;var textureSampler: texture_2d<f32>;
#if defined(INITIAL)
...
`;
    ...
    minmaxReduxPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-LQMPDUN7.js.map
