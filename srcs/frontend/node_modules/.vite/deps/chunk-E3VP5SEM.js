    ...
    RGBDTextureTools = class {
      ...
      static ExpandRGBDTexture(texture) {
        ...
        const expandRgbdTextureAsync = async () => {
          ...
          internalTexture.isReady = false;
          if (isWebGpu) {
            await import("./rgbdDecode.fragment-JU2LACMF.js");
          } else {
            await import("./rgbdDecode.fragment-Y7W7BSHE.js");
          }
      ...
      static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
          await import("./rgbdEncode.fragment-KGXCZWS6.js");
        } else {
          await import("./rgbdEncode.fragment-DKTATXJO.js");
        }
...
//# sourceMappingURL=chunk-E3VP5SEM.js.map
