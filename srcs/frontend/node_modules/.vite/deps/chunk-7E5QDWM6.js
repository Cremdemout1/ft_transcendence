...
async function _CreateDumpRendererAsync() {
  if (!EnginePromise) {
    EnginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-3DGKZM4Z.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-HQUZMS5W.js").then(({ passPixelShader }) => {
          if (!engine) {
...
function Dispose() {
  if (DumpToolsEngine) {
    ...
    EnginePromise == null ? void 0 : EnginePromise.then((dumpToolsEngine) => {
      dumpToolsEngine.wrapper.dispose();
      dumpToolsEngine.renderer.dispose();
      dumpToolsEngine.engine.dispose();
    });
...
var DumpToolsEngine, EnginePromise, DumpTools, InitSideEffects;
...
//# sourceMappingURL=chunk-7E5QDWM6.js.map
