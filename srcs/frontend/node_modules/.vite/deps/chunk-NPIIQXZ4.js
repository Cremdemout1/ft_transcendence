          ...
          const effect = scene.getEngine().createEffect("gaussianSplatting", {
            ...
            extraInitializationsAsync: async () => {
              if (this._shaderLanguage === 1) {
                await Promise.all([import("./gaussianSplatting.fragment-I32TSGOX.js"), import("./gaussianSplatting.vertex-ZK4YLYXP.js")]);
              } else {
                await Promise.all([import("./gaussianSplatting.fragment-IUI7Y5WB.js"), import("./gaussianSplatting.vertex-GH2GD4LO.js")]);
              }
            }
          }, engine);
...
var UnpackUnorm, Unpack111011, Unpack8888, UnpackRot, PLYType, PLYValue, GaussianSplattingMesh;
    ...
    GaussianSplattingMesh = class _GaussianSplattingMesh extends Mesh {
      ...
      _copyTextures(source) {
        ...
        if (source._shTextures) {
          this._shTextures = [];
          for (const shTexture of this._shTextures) {
            (_e = this._shTextures) == null ? void 0 : _e.push(shTexture.clone());
          }
        }
      }
      /**
...
var CloudPoint, PointsGroup;
var init_cloudPoint = __esm({
  "node_modules/@babylonjs/core/Particles/cloudPoint.js"() {
    init_math();
    CloudPoint = class {
      /**
...
var PointColor, PointsCloudSystem;
var init_pointsCloudSystem = __esm({
  "node_modules/@babylonjs/core/Particles/pointsCloudSystem.js"() {
    init_math();
    init_math_vector();
    init_logger();
...
//# sourceMappingURL=chunk-NPIIQXZ4.js.map
