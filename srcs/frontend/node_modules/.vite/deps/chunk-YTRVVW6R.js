import {
  init_math_axis
} from "./chunk-BD4XZQSQ.js";
import {
  init_math_path
} from "./chunk-IQRGIA4T.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray,
  ...
  init_smartArray
} from "./chunk-FINCLYZP.js";
import {
  PerfCounter,
  init_perfCounter
} from "./chunk-PTPKZBOI.js";
import {
  BaseTexture,
  Texture,
  init_baseTexture,
...
import {
  init_math_plane
} from "./chunk-AFXPFQEE.js";
import {
  SerializationHelper,
  init_decorators_serialization,
  init_math_size
} from "./chunk-X6S3ONFS.js";
import {
  __decorate,
  init_decorators,
  init_tslib_es6,
...
} from "./chunk-T45CF7XN.js";
import {
  EffectWrapper,
  init_effectRenderer,
  init_math_viewport
} from "./chunk-BMITKGW3.js";
import {
  GetClass,
  RegisterClass,
  init_typeStore
} from "./chunk-O2KDGBWB.js";
import {
  AbstractEngine,
  Effect,
  FloorPOT,
    ...
    RenderTargetTexture = class _RenderTargetTexture extends Texture {
      ...
      isReadyForRendering() {
        if (!this._dumpToolsLoading) {
          ...
          import("./dumpTools-GCM47WUI.js").then((module) => this._dumpTools = module);
        }
    ...
    PostProcess = class _PostProcess {
      ...
      _gatherImports(useWebGPU = false, list) {
        if (useWebGPU && this._webGPUReady) {
          list.push(Promise.all([import("./postprocess.vertex-MIV4WMPF.js")]));
        } else {
          list.push(Promise.all([import("./postprocess.vertex-KGABGYPT.js")]));
        }
      }
      /**
  ...
  "node_modules/@babylonjs/core/Engines/Extensions/engine.prefilteredCubeTexture.js"() {
    ...
    ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
      const callbackAsync = async (loadData) => {
        ...
        const { DDSTools } = await import("./dds-ZUQTQAEE.js");
        const textures = [];
  ...
  "node_modules/@babylonjs/core/PostProcesses/thinPassPostProcess.js"() {
    ...
    ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
      _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
          ...
          list.push(Promise.all([import("./pass.fragment-UOYDBKAO.js")]));
        } else {
          list.push(Promise.all([import("./pass.fragment-HQUZMS5W.js")]));
        }
    ...
    ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
      _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
          this._webGPUReady = true;
          list.push(Promise.all([import("./passCube.fragment-MLGLFNBF.js")]));
        } else {
          list.push(Promise.all([import("./passCube.fragment-YXVZQ43U.js")]));
        }
        super._gatherImports(useWebGPU, list);
      }
      /**
...
var init_textureTools = __esm({
  "node_modules/@babylonjs/core/Misc/textureTools.js"() {
    ...
    ProcessAsync = async (texture, width, height, face, lod) => {
      ...
      if (!engine.isWebGPU) {
        if (texture.isCube) {
          await import("./lodCube.fragment-LUUB5BHW.js");
        } else {
          await import("./lod.fragment-J74TL56I.js");
        }
      } else {
        if (texture.isCube) {
          await import("./lodCube.fragment-HJSHYHIS.js");
        } else {
          await import("./lod.fragment-M32ZYMTK.js");
        }
      }
      let lodPostProcess;
      if (!texture.isCube) {
...
//# sourceMappingURL=chunk-YTRVVW6R.js.map
