...
// node_modules/@babylonjs/addons/msdfText/shadersWGSL/msdf.vertex.js
var name, shader, msdfVertexShaderWGSL;
var init_msdf_vertex = __esm({
  "node_modules/@babylonjs/addons/msdfText/shadersWGSL/msdf.vertex.js"() {
    init_shaderStore();
    name = "msdfVertexShader";
    shader = `#define BILLBOARD 1
...
input.uvs.y+(1.0-input.offsets.y)*input.uvs.w
    ...
    msdfVertexShaderWGSL = { name, shader };
  }
});

export {
  msdfVertexShaderWGSL,
  init_msdf_vertex
};
//# sourceMappingURL=chunk-VLOOTJY7.js.map
